...
//                                 |--------+--------+--------+--------+--------|
#define ________L_NUM_3________      _______, KC_MS_L, KC_MS_D, KC_MS_R, KC_CCCP
//                                 |--------+--------+--------+--------+--------|
#define ________L_NUM_4________      _______, KC_LPRN, KC_RPRN, KC_UNDS, KC_WH_U
//                                 `--------+--------+--------+--------+--------'
...
//                                 |--------+--------+--------+--------+--------|
#define ________R_NUM_4________      _______, _______,  KC_0  , _______, _______
//                                 `--------+--------+--------+--------+--------'
