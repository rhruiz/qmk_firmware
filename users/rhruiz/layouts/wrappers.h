...
//                                 |--------+--------+--------+--------+--------|
#define ________L_BL_R3________ HRL(  KC_A  ,  KC_S  ,  KC_D  ,  KC_F  ,  KC_G  )
//                                 |--------+--------+--------+--------+--------|
...
//                                 |--------+--------+--------+--------+--------|
#define ________R_BL_R3________ HRR(  KC_H  ,  KC_J  ,  KC_K  ,  KC_L  , KC_SCLN)
//                                 |--------+--------+--------+--------+--------|
...
//                                 |--------+--------+--------+--------+--------|
#define _______L_ISRT_R3_______ HRL(  KC_I  ,  KC_S  ,  KC_R  ,  KC_T  ,  KC_G  )
//                                 |--------+--------+--------+--------+--------|
...
//                                 |--------+--------+--------+--------+--------|
#define _______R_ISRT_R3_______ HRR(  KC_P  ,  KC_N  ,  KC_E  ,  KC_A  ,  KC_O  )
//                                 |--------+--------+--------+--------+--------|
...
//                                 |--------+--------+--------+--------+--------|
#define _______L_NORM_R3_______ HRL(  KC_A  ,  KC_S  ,  KC_E  ,  KC_T  ,  KC_G )
//                                 |--------+--------+--------+--------+--------|
...
//                                 |--------+--------+--------+--------+--------|
#define _______R_NORM_R3_______ HRR(  KC_Y  ,  KC_N  ,  KC_I  ,  KC_O  ,  KC_H )
//                                 |--------+--------+--------+--------+--------|
...
//                                 |--------+--------+--------+--------+--------|
#define _______L_COLE_R3_______ HRL(  KC_A  ,  KC_R  ,  KC_S  ,  KC_T  ,  KC_D )
//                                 |--------+--------+--------+--------+--------|
...
//                                 |--------+--------+--------+--------+--------|
#define _______R_COLE_R3_______ HRR(  KC_H  ,  KC_N  ,  KC_E  ,  KC_I  ,  KC_O )
//                                 |--------+--------+--------+--------+--------|
...
//                                 |--------+--------+--------+--------+--------|
#define _______L_CODH_R3_______ HRL(  KC_A  ,  KC_R  ,  KC_S  ,  KC_T  ,  KC_G )
//                                 |--------+--------+--------+--------+--------|
#define _______L_CODH_R4_______       KC_Z  ,  KC_X  ,  KC_C  ,  KC_D  ,  KC_V
//                                 `--------+--------+--------+--------+--------'

//                                 .--------------------------------------------.
#define _______R_CODH_R1_______       KC______NUMBERS_RGHT_____
//                                 |--------+--------+--------+--------+--------|
#define _______R_CODH_R2_______       KC_J  ,  KC_L  ,  KC_U  ,  KC_Y  , KC_SCLN
//                                 |--------+--------+--------+--------+--------|
#define _______R_CODH_R3_______ HRR(  KC_M  ,  KC_N  ,  KC_E  ,  KC_I  ,  KC_O )
//                                 |--------+--------+--------+--------+--------|
...
//                                 |--------+--------+--------+--------+--------|
#define ________R_LWR_2________      _______, KC_EPIP, KC_ASTR, KC_BSLS, KC_COLN
//                                 |--------+--------+--------+--------+--------|
#define ________R_LWR_3________      KC_GRV , KC_AMPR, KC_PIPE, KC_CIRC, KC_QUOT
//                                 |--------+--------+--------+--------+--------|
#define ________R_LWR_4________      _______, KC_COLN, KC_SCLN, KC_GRV , KC_QUES
//                                 `--------+--------+--------+--------+--------'

//                                 .--------------------------------------------.
#define ________L_RSE_1________      KC_SLCK, KC_PAUS, MISCTRL, _______, _______
//                                 |--------+--------+--------+--------+--------|
#define ________L_RSE_2________                _____NUMBERS_LEFT_____
//                                 |--------+--------+--------+--------+--------|
#define ________L_RSE_3________      KC_CTAB, KC__TAP, KC__TAN, KC_TAB , _______
//                                 |--------+--------+--------+--------+--------|
...
//                                 |--------+--------+--------+--------+--------|
#define ________R_RSE_3________      KC_PLUS, KC_LEFT, KC_DOWN,  KC_UP , KC_RGHT
//                                 |--------+--------+--------+--------+--------|
#define ________R_RSE_4________      KC_MINS, KC_ASTR, KC_COMM, KC_DOT , KC_SLSH
//                                 `--------+--------+--------+--------+--------'
...
//                                 |--------+--------+--------+--------+--------|
#define ________L_CFG_3________      NXT_WIN, KC__BCK, KC__FWD,  STAB  , TG_GAME
//                                 |--------+--------+--------+--------+--------|
#define ________L_CFG_4________      KC__VUP, KC__VDN, KC_MUTE, KC_EJCT, _______
//                                 `--------+--------+--------+--------+--------'

//                                 .--------+--------+--------+--------+--------.
#define ________R_CFG_1________      _______, _______, _______, _______, _______
//                                 |--------+--------+--------+--------+--------|
#define ________R_CFG_2________      KC_LAYO, KC__BOL, KC__SBT, KC__STP, KC__EOL
//                                 |--------+--------+--------+--------+--------|
#define ________R_CFG_3________      _______, KC__WL , KC_PGDN, KC_PGUP, KC__WR
//                                 |--------+--------+--------+--------+--------|
