...
//                                 .--------------------------------------------.
#define ________L_RSE_1________      KC_SCRL, KC_PAUS, NV_MICT, _______, _______
//                                 |--------+--------+--------+--------+--------|
#define ________L_RSE_2________                _____NUMBERS_LEFT_____
//                                 |--------+--------+--------+--------+--------|
#define ________L_RSE_3________      KC_CTAB, NV_TAP , NV_TAN , KC_TAB , _______
//                                 |--------+--------+--------+--------+--------|
#define ________L_RSE_4________      A_SPACE, _______, CW_TOGG, KC_ESC , _______
//                                 `--------+--------+--------+--------+--------'
...
//                                 |--------+--------+--------+--------+--------|
#define ________R_RSE_4________      _______, KC_BSPC, OSL_FUN, _______, TG_NUM
//                                 `--------+--------+--------+--------+--------'
