...
//                                 |--------+--------+--------+--------+--------|
#define ________L_LWR_2________      KC_HASH, KC_LCBR, KC_RCBR, KC_DLR , KC_PERC
//                                 |--------+--------+--------+--------+--------|
#define ________L_LWR_3________      KC_EXLM, KC_LBRC, KC_RBRC, KC_MINS, KC_UNDS
//                                 |--------+--------+--------+--------+--------|
...
//                                 |--------+--------+--------+--------+--------|
#define ________R_LWR_2________      KC_PDIR, KC_EPIP, KC_CIRC, KC_AMPR, _______
//                                 |--------+--------+--------+--------+--------|
#define ________R_LWR_3________      KC_GRV , KC_COLN, KC_ASTR, KC_PIPE, KC_QUOT
//                                 |--------+--------+--------+--------+--------|
#define ________R_LWR_4________      KC_TILD, KC_SCLN, KC_ARRW, KC_FARW, KC_BSLS
//                                 `--------+--------+--------+--------+--------'
...
//                                 |--------+--------+--------+--------+--------|
#define ________L_RSE_4________      _______, _______, CAPSWRD, KC_ESC , _______
//                                 `--------+--------+--------+--------+--------'
...
//                                 |--------+--------+--------+--------+--------|
#define ________R_RSE_4________      _______, KC_CCCP, OSL_FUN, _______, _______
//                                 `--------+--------+--------+--------+--------'
...
//                                 |--------+--------+--------+--------+--------|
#define ________L_FUN_2________      _______, _______, _______, _______, _______
//                                 |--------+--------+--------+--------+--------|
#define ________L_FUN_3________      KC_LCTL, KC_LSFT, KC_LALT, KC_LGUI, _______
//                                 |--------+--------+--------+--------+--------|
