...
/*  |--------+-----+-----+-----+-----+-----|   |-----+-----+-----+-----+-----+--------|*/ \
      CTRLESC, L11 , L12 , L13 , L14 , L15 ,     R11 , R12 , R13 , R14 , R15 , KC_QUOT, \
/*  |--------+-----+-----+-----+-----+-----|   |-----+-----+-----+-----+-----+--------|*/ \
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|--------+--------------------------------------------|  |-----------------+--------------------------+--------|
      KC_SCTL,           _____NUMBERS_RGHT_____           ,    _______, _______, _______, _______, _______, _______,
  //|--------+--------------------------------------------|  |-----------------+--------------------------+--------|
  ...
  //,-----------------------------------------------------.  ,-----------------------------------------------------.
      _______, _______,  KC_NO , _______,  KC_NO , _______,    KC_ASTR, _______,  KC_8  , _______, KC_MINS, _______,
  //|--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------|
      _______, _______, KC_MS_L, _______, KC_MS_R, _______,    KC_SLSH, _______,  KC_5  , _______, KC_PLUS, _______,
  //|--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------|
      _______, _______, _______, _______, _______, _______,    KC_COMM, _______,  KC_2  , _______, KC_DOT , _______,
  //`--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------'
