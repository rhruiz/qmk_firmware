...
/*  `--------+-----------------------------|   |-----------------------------+--------'*/ \
                  KC_LGUI, MO_LWR , CT_SPC ,     ST_ENT , MO_RSE ,  AT_BS               \
/*              `--------+--------+--------'   `--------+--------+--------'            */ \
  )
...
//,-----------------------------------.  ,-----------------------------------.
    KC_TAB ,  _____NUMBERS_LEFT_____  ,     _______________________ , _______,
//|--------+--------------------------|  |--------------------------+--------|
    S_LCTL ,  _____NUMBERS_RGHT_____  ,     _______________________ , _______,
//|--------+--------------------------|  |--------------------------+--------|
    KC_LALT,  ____FUNCTIONS_LEFT____  ,     _______________________ , _______,
//`--------+--------------------------|  |--------------------------+--------'
...
//`--------+--------------------------|  |--------------------------+--------'
             _______, _______, _______,    _______, _______, AT_DEL
//         `--------+--------+--------'  `--------+--------+--------'
  ),
...
//|--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------|
    _______, _______, KC_MS_L, KC_MS_D, KC_MS_R, KC_CCCP,    KC_ASTR,  KC_4  ,  KC_5  ,  KC_6  , KC_PLUS, TG_NUM ,
//|--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------|
    _______, _______, KC_LPRN, KC_RPRN, KC_UNDS, KC_WH_U,    KC_COMM,  KC_1  ,  KC_2  ,  KC_3  , KC_DOT , _______,
//`--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------'
                               KC_BTN2, _______, KC_BTN1,    _______,LT_RSE_0, _______
//                           `--------+--------+--------'  `--------+--------+--------'
    ),
