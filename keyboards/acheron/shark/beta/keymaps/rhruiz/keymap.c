...
/*  |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------| */ \
      MO_NUM , KC_ESC , KC_TAB , KC_LGUI, MO_LWR , CT_SPC , ST_ENT , MO_RSE ,  AT_BS , KC_RGUI, KC_DEL , MO_NUM    \
/*  `--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------' */ \
  )
...
//`--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------'
  ...
  [_KEY_OVERRIDE] = LAYOUT_kc_wrapper(
//|-----+-----+-----+-----+-----+-----+-----+-----+-----+-----+-----+-----|
    GRV ,     ,     ,     ,     ,     ,     ,     ,     ,     ,     , DEL ,
//|-----+-----+-----+-----+-----+-----+-----+-----+-----+-----+-----+-----|
    TILD,     ,     ,     ,     ,     ,     ,     ,     ,     ,     , DQUO,
...
//|--------+--------------------------------------------+--------------------------------------------+--------|
    _______, _______, _______, KC_BTN2, _______, KC_BTN1, _______, _______,  AT_0  , _______, _______, _______
//`--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------'
  ),
