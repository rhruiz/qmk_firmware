...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BL] = LAYOUT_ortho_5x14_wrapper(
 //,--------------------------------------------+--------+--------.  ,--------+--------+--------------------------------------------.
       ________L_BL_R1________                  , KC_GRV , KC_MINS,    TG_NUM , KC_EQL ,                  ________R_BL_R1________   ,
 //|--------------------------------------------+--------+--------|  |--------+--------+--------------------------------------------+
       ________L_BL_R2________                  , KC_TAB , NV_NWIN,    NV_TAN , KC_BSPC,                  ________R_BL_R2________   ,
 //|--------------------------------------------+--------+--------|  |--------+--------+--------------------------------------------+
       ________L_BL_R3________                  , KC_ESC , KC_PGUP,    NV_BCK , KC_QUOT,                  ________R_BL_R3________   ,
 //|--------------------------------------------+--------+--------|  |--------+--------+--------------------------------------------+
       ________L_BL_R4________                  , KC_LSFT, KC_PGDN,    KC_EPIP, KC_RSFT,                  ________R_BL_R4________   ,
 //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------+
