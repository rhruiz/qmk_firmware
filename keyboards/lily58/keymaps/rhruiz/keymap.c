...
void rhruiz_render_logo_and_layer(void) {
    ...
    const char logo2[] = { 0x20, 0x20, 0xbd, 0xbe, 0xbf, 0x20, 0xa6, 0xa7, 0xa8, 0xa9, 0xaa, 0xab, 0xac, 0xad, 0xc9, 0xaf, 0xb0, 0x20, lc[layer][1][0], lc[layer][1][1], 0 };
    const char logo3[] = { 0x20, 0x20, 0xdd, 0xde, 0xdf, 0x20, 0xc6, 0xc7, 0xc8, 0xc9, 0xca, 0xcb, 0xcc, 0xcd, 0xc9, 0xcf, 0xd0, 0x20, lc[layer][2][0], lc[layer][2][1], 0 };
