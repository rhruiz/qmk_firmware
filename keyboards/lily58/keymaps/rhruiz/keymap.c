...
// |-----+-----+-----+-----+-----+-----|-----|    |-----|-----+-----+-----+-----+-----+-----|
     LSFT,  Z  ,  X  ,  C  ,  V  ,  B  , LBRC,      EPIP,  N  ,  M  , COMM, DOT , SLSH, RSFT,
// `-----+-----+-----+-----+-----+----/-----/      \-----\----+-----+-----+-----+-----+-----'
...
static const char lc[][3][3] = {
    ...
    [_FN1] = { { 0x80, 0x80, 0 }, { 0xa0, 0xa1, 0 }, { 0xc0, 0xc1, 0 } },
    [_FN2] = { { 0x80, 0x80, 0 }, { 0xa0, 0xa1, 0 }, { 0xc2, 0xc3, 0 } },
...
void rhruiz_render_logo_and_layer(void) {
    ...
    const char logo1[] = { 0x20, 0x20, 0x9d, 0x9e, 0x9f, 0x20, 0x86, 0x87, 0x88, 0x89, 0x8a, 0x8b, 0x8c, 0x8d, 0x8e, 0x8f, 0x90, 0x20, lc[layer][0][0], lc[layer][0][1], 0 };
    const char logo2[] = { 0x20, 0x20, 0xbd, 0xbe, 0xbf, 0x20, 0xa6, 0xa7, 0xa8, 0xa9, 0xaa, 0xab, 0xac, 0xad, 0xae, 0xaf, 0xb0, 0x20, lc[layer][1][0], lc[layer][1][1], 0 };
